    ...
    <div role="dialog" aria-modal="true" aria-label="Checkout ZXMAX" className="fixed inset-0 z-[80] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        ...
        <div className="p-6 space-y-5">
          ...
          <button onClick={handleConfirm} disabled={loading || loadingMethods || !method || !isAvailable(method)} className="w-full bg-[#2B7FFF] hover:bg-[#1a6eef] text-white py-4 rounded-xl font-black text-sm flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed transition">
            {loading ? "Processando..."
          ...
          <div className="grid lg:grid-cols-[1fr_360px] gap-6">
            <div className="space-y-4">
              ...
              <div className="bg-[#15151a] border border-[#25252e] rounded-2xl p-5">
                ...
                <button onClick={handleBuyClick} disabled={buyLoading} className="w-full mt-5 bg-[#2B7FFF] hover:bg-[#1a6eef] text-white py-4 rounded-xl font-black text-base transition disabled:opacity-50">Comprar agora</button>
            ...
            <div className="space-y-4">
              <div className="bg-[#15151a] border border-[#25252e] rounded-2xl p-5">
                ...
                <button onClick={handleBuyClick} className="w-full mt-4 bg-[#2B7FFF] text-white py-3.5 rounded-xl font-black">Comprar agora</button>
              </div>
